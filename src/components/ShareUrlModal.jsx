...
const ShareUrlModal = ({setShowModal,url}) => {
  ...
  return (
    <div className='w-screen h-screen fixed z-30 top-0 bg-black/30 flex justify-center items-center'>
    <main className='bg-white  h-fit  rounded-lg shadow-md px-4 py-10 mx-4 lg:w-1/4 md:w-2/4 sm:w-2/3'>
        <section className='flex justify-between items-center mx-3'>
            <h1 className='text-lg font-semibold text-gray-700'>Here's the url with filters</h1>
